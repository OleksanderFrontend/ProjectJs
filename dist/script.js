...
var changeModalState = function changeModalState(state) {
  var windowsForms = document.querySelectorAll('.balcon_icons_img '),
...
var checkNumberInput = function checkNumberInput(selector) {
  var numberInput = document.querySelectorAll(selector);
...
/* harmony default export */ __webpack_exports__["default"] = (checkNumberInput);
...
var forms = function forms(state) {
  ...
  var postInfromation = function postInfromation(url, data) {
    var res;
    return regeneratorRuntime.async(function postInfromation$(_context) {
      while (1) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var dataForm = new FormData(item);
      ...
      postInfromation('assets/server.php', dataForm).then(function (res) {
        console.log(res);
...
var images = function images() {
  var imagesWork = document.createElement('div'),
  ...
  wrapperImg.addEventListener('click', function (e) {
    e.preventDefault();
    var target = e.target;
    ...
    if (target && target.classList.contains('preview')) {
      ...
      var path = target.closest('a').getAttribute('href');
      console.log(path);
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.overflow = 'hidden';
        document.body.style.marginRight = "".concat(calcModal, "px");
      });
    });
...
var tabs = function tabs(headerSelector, tabsSelector, tabContentSelector, activeClass) {
